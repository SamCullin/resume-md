...
def main():
    ...
    try:
        ...
        banner = next((c for c in components if c.get_component_type() == "banner"), None)
        if banner:
        ...
        print("Open this file in a browser and use the Print button or Ctrl+P to create a PDF")
